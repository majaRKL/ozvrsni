...
\lstset{ %
    ...
    language=C,
    morekeywords={new},            
    keywords=[2]{imread, VideoCapture, Mat, cvtColor, Rect,
    matchTemplate, normalize, Point, minMaxLoc, rectangle,
    imshow, namedWindow, PointXYZRGBNormal, PointCloud, Ptr,
    PolygonMesh, CV\_WINDOW\_AUTOSIZE, waitKey, boost, cout,
...
\include{05-video-template-matching}
\include{06-results}
